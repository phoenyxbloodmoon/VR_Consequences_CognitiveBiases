...
#Checking Normality/ If non-parametric
#See aq3_t_test

#Using Spearman for non-parametric testing 
cor.test(corr_data2$GAMBLER, corr_data2$CRT, method = 'spearman') 
cor.test(corr_data2$GAMBLER, corr_data2$CONJUNCTION, method = 'spearman') 
cor.test(corr_data2$CRT, corr_data2$CONJUNCTION, method = 'spearman') 
...
#PEARSONS
cor.test(corr_reaction2$GAMBLER, corr_data2$CRT, method = 'spearman') 
cor.test(corr_reaction2$GAMBLER, corr_data2$CONJUNCTION, method = 'spearman') 
cor.test(corr_reaction2$CRT, corr_data2$CONJUNCTION, method = 'spearman') 
